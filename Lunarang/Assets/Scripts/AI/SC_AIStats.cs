...
public class SC_AIStats : MonoBehaviour
{
    ...
    [Tooltip("Current base HP of the enemy")] public float hpBase = 5;
    [Tooltip("Current HP multiplier of the enemy")] public float hpMultiplier = 1;
    ...
    [Tooltip("Current DEF multiplier of the enemy")] public float defMultiplier = 1;
    ...
    [Tooltip("Current ATK multiplier of the enemy")] public float atkMultiplier = 1;
    ...
    [Tooltip("Current Speed multiplier of the enemy")] public float speedMultiplier = 1;
