...
public class AI_BadKyu_PatrolState : BaseState<AI_StateMachine.EnemyState>
{
    
    public AI_BadKyu_PatrolState(AI_StateMachine.EnemyState key, AI_BadKyu_StateMachine manager) : base(key , manager)
    {
